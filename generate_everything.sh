...
hcxpcaptool -o ${OUTDIR}o -O ${OUTDIR}O -z ${OUTDIR}z -j ${OUTDIR}j -J ${OUTDIR}J -E ${OUTDIR}E -I ${OUTDIR}I -U ${OUTDIR}U -P ${OUTDIR}P -T ${OUTDIR}T -g ${OUTDIR}g -V ${INFILE}
#--netntlm-out=${OUTDIR}netntlm-out --md5-out=${OUTDIR}md5-out --md5-john-out=${OUTDIR}md5-john-out --tacacsplus-out=${OUTDIR}tacacsplus-out --eapol-out=${OUTDIR}eapol-out --network-out=${OUTDIR}network-out --hexdump-out=${OUTDIR}hexdump-out --hccap-out=${OUTDIR}hccap-out --hccap-raw-out=${OUTDIR}hccap-raw-out
