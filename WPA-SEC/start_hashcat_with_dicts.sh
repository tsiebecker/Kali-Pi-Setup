...
hashcat -m 2500 --nonce-error-corrections=128 --remove --logfile-disable -a 0 -w 4 --potfile-path=${OUTDIR}hashcat.2500.pot --outfile-format=2 -o ${OUTDIR}foundhashcat.2500 ${OUTDIR}database_best.hccapx ${DICT}
...
then
	...
	hashcat -m 2500 --nonce-error-corrections=128 --remove --logfile-disable -a 0 -w 4 --potfile-path=${OUTDIR}hashcat.2500.pot --outfile-format=2 -o ${OUTDIR}foundhashcat.2500 ${OUTDIR}database_all.hccapx ${DICT}
